...
class Model:
    ...
    def inception_C(self, x, n, output, name):
        ...
        with tf.variable_scope(name):
            ...
            L1x1 = tf.nn.elu(L1x1, 'inceptionC_L1x1_R')
            ...
            L5x5_sub1 = tf.nn.elu(L5x5_sub1, 'inceptionC_L5x5_sub1_R')
            ...
            L5x5_sub2 = tf.nn.elu(L5x5_sub2, 'inceptionC_L5x5_sub2_R')
            ...
            L5x5_sub3 = tf.nn.elu(L5x5_sub3, 'inceptionC_L5x5_sub3_R')
            ...
            L5x5_sub4 = tf.nn.elu(L5x5_sub4, 'inceptionC_L5x5_sub4_R')
            ...
            L3x3_sub1 = tf.nn.elu(L3x3_sub1, 'inceptionC_L3x3_sub1_R')
            ...
            L3x3_sub2 = tf.nn.elu(L3x3_sub2, 'inceptionC_L3x3_sub2_R')
            ...
            L3x3_sub3 = tf.nn.elu(L3x3_sub3, 'inceptionB_L3x3_sub1_R')
            ...
            L_pool_sub1 = tf.nn.elu(L_pool_sub1, 'inceptionC_L_pool_sub1_R')
