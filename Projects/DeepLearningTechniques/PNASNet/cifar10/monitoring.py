...
class Monitoring:
    ...
    def _mon_data_from_db(self):
        ...
        cur.execute('select train_type, acc, loss from neuralnet_train_log where dataset = :dataset model = :model and seq = :seq order by train_type, epoch',
...
mon = Monitoring(dataset='cifar10', model='pnasnet-5', seq=1)