...
class Monitoring:
    train_acc_list = deque(maxlen=600)
    train_loss_list = deque(maxlen=600)
    valid_acc_list = deque(maxlen=600)
    valid_loss_list = deque(maxlen=600)
    ...
    def __init__(self, dataset, model, seq):
        ...
        self.acc_subplot.set_xlim(0, 600)
        ...
        self.loss_subplot.set_xlim(0, 600)
...
mon = Monitoring(dataset='cifar10', model='nasnet-a', seq=4)