    ...
    def _build_graph(self):
        with tf.variable_scope(name_or_scope=self.name, reuse=tf.AUTO_REUSE):
            ...
            with tf.variable_scope(name_or_scope='body_scope'):
                ...
                # todo shake stage-1
                x = self.shake_stage(x=x, output_filters=32 * self.k, num_blocks=self.num_blocks, strides=2, name='shake_stage_1')
            ...
            with tf.variable_scope(name_or_scope='output_scope'):
                ...
                self.decay_lr = tf.train.cosine_decay(self.lr, self.global_step, 390 * flags.FLAGS.epoch)
