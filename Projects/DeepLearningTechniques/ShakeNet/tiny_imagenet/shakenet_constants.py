...
flags.DEFINE_string('train_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/EyeOclock/tiny_imagenet/train_log',
                    '훈련 시 체크포인트 파일 저장 경로')

flags.DEFINE_string('deploy_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/EyeOclock/tiny_imagenet/deploy_log',
                    'Model Deploy 시 사용될 체크포인트 파일 저장 경로')

flags.DEFINE_string('cam_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/EyeOclock/tiny_imagenet/cam_log',
                    'CAM 이미지 및 체크포인트 파일 저장 경로')

flags.DEFINE_string('tensorboard_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/EyeOclock/tiny_imagenet/tensorboard_log',
                    'Tensor Board 에서 시각화하기 위해 저장되는 로그 경로')

flags.DEFINE_string('roc_curve_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/EyeOclock/tiny_imagenet/roc_curve_log',
                    'ROC Curve 그래프가 저장 되는 경로')

flags.DEFINE_string('cfm_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/EyeOclock/tiny_imagenet/cfm_log',
