...
flags.DEFINE_string('train_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/MultiGPU/NCCL/train_log/01',
                    '훈련 시 체크포인트 파일 저장 경로')

flags.DEFINE_string('deploy_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/MultiGPU/NCCL/deploy_log/01',
                    'Model Deploy 시 사용될 체크포인트 파일 저장 경로')

flags.DEFINE_string('cam_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/MultiGPU/NCCL/cam_log/01',
                    'CAM 이미지 및 체크포인트 파일 저장 경로')

flags.DEFINE_string('tensorboard_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/MultiGPU/NCCL/tensorboard_log/01',
                    'Tensor Board 에서 시각화하기 위해 저장되는 로그 경로')

flags.DEFINE_string('roc_curve_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/MultiGPU/NCCL/roc_curve_log/01',
                    'ROC Curve 그래프가 저장 되는 경로')

flags.DEFINE_string('cfm_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/MultiGPU/NCCL/cfm_log/01',
