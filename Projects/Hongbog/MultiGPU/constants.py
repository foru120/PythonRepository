...
flags.DEFINE_string('root_data_path',
                    # 'G:/04.dataset/02.cifar10/cifar10_tfrecord_test',
                    'G:/04.dataset/02.cifar10/cifar10_tfrecord/cifar10',
                    '학습 데이터 경로 (cifar-10)')

flags.DEFINE_string('train_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/MultiGPU/train_log',
                    '훈련 시 체크포인트 파일 저장 경로')

flags.DEFINE_string('deploy_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/MultiGPU/deploy_log',
...
flags.DEFINE_string('tensorboard_log_path',
                    'D:/Source/PythonRepository/Projects/Hongbog/MultiGPU/tensorboard_log',
