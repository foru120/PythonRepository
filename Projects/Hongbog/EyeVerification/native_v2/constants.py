...
flags.DEFINE_string('right_train_data_path',
                    'G:/04_dataset/eye_verification/eye_dataset_v3/train/right',
                    '오른쪽 눈 학습 데이터 경로')
...
flags.DEFINE_string('left_train_data_path',
                    'G:/04_dataset/eye_verification/eye_dataset_v3/train/left',
                    '왼쪽 눈 학습 데이터 경로')
...
flags.DEFINE_string('trained_weight_dir',
                    'D:/Source/PythonRepository/Projects/Hongbog/EyeVerification/native_v2/train_log/014',
                    '훈련된 가중치 값 저장 경로')
...
flags.DEFINE_string('tensorboard_log_dir',
                    'D:/Source/PythonRepository/Projects/Hongbog/EyeVerification/native_v2/tensorboard_log/014',
                    '텐서보드에서 모니터링 변수 저장 경로')

flags.DEFINE_string('deploy_log_dir',
                    'D:/Source/PythonRepository/Projects/Hongbog/EyeVerification/native_v2/deploy_log/014',
