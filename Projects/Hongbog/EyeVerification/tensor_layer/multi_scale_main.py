...
from Hongbog.EyeVerification.tensor_layer.model_v4 import Model
...
class Neuralnet:
    ...
    def _flag_setting(self):
        ...
        flags.DEFINE_string('train_right_root_path', 'E:\\04_dataset\\eye_verification\\eye_only_v3\\train\\right', '오른쪽 눈 학습 데이터 경로')
        flags.DEFINE_string('test_right_root_path', 'E:\\04_dataset\\eye_verification\\eye_only_v3\\test\\right', '오른쪽 눈 테스트 데이터 경로')
        flags.DEFINE_string('train_left_root_path', 'E:\\04_dataset\\eye_verification\\eye_only_v3\\train\\left', '왼쪽 눈 학습 데이터 경로')
        flags.DEFINE_string('test_left_root_path', 'E:\\04_dataset\\eye_verification\\eye_only_v3\\test\\left', '왼쪽 눈 테스트 데이터 경로')
        ...
        flags.DEFINE_string('trained_param_path',
                            'D:/Source/PythonRepository/Hongbog/EyeVerification/train_log/4_5th_test',
                            '훈련된 파라미터 값 저장 경로')
