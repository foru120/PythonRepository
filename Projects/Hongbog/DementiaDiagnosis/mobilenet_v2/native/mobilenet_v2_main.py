from Projects.Hongbog.DementiaDiagnosis.mobilenet_v2.native.constants import *
from Projects.Hongbog.DementiaDiagnosis.mobilenet_v2.native.dataloader import DataLoader
from Projects.Hongbog.DementiaDiagnosis.mobilenet_v2.native.mobilenet_v2_model import *
from Projects.Hongbog.DementiaDiagnosis.mobilenet_v2.native.cam import GradCAM, GuidedGradCAM
...
class Neuralnet:
    ...
    def cam_test(self, sort='grad_cam'):
        ...
        img_size = (224, 400)
        sample_path = 'G:/04_dataset/gelontoxon/gelontoxon_cam_v2'
        ...
        def save_matplot_img(cam_outputs, sample_num, class_num, file_name):
            ...
            f.savefig(os.path.join('D:/Source/PythonRepository/Projects/Hongbog/DementiaDiagnosis/mobilenet_v2/native/cam_img', file_name))
            print('>> CAM Complete')
