...
class Generator:
    ...
    def __init__(self, depths, s_size=4):
        ...
        self.s_size = s_size
        self.output_size = [(4, 4), (6, 7), (12, 14), (23, 28), (45, 55), (89, 109), (178, 218)]
        self.pad_size = [(2, 2), (2, 3), (6, 7), (11, 14), (22, 27), (44, 54)]
    ...
    def __call__(self, inputs, training=False, reuse=False, name='g'):
        ...
        def deconvolution(layer, name, idx):
            with tf.variable_scope(name):
                layer = tl.layers.PadLayer(layer, padding=[[0, 0], [self.pad_size[idx-1][0], self.pad_size[idx-1][0]],
                                                           [self.pad_size[idx-1][1], self.pad_size[idx-1][1]], [0, 0]], mode='REFLECT')
                if idx == 6:
...
class CDCGAN:
    def __init__(self, sess, batch_size=100, z_dim=100, img_size=(178, 218), learning_rate=0.0002,
                 g_depths=[512, 256, 128, 64, 32, 16], d_depths=[8, 16, 32, 64, 128, 256]):
        self.sess = sess
